...
- make sure the oracle db connction is ok, and run the program as the syntax:
    ...
    - and -o is the output file name, the program will generate 2 kinds of file, .docx and .sql, the information is optional, and default file will be schemaYYYYMMDDMISS